...
lab:
  ...
  description: In this exercise, you run an ASP.NET Core minimal API locally and explore
    the API and the underlying code. You also publish the API to Azure App Service.
  duration: 30 minutes
  level: 200
  islab: true
  primarytopics:
